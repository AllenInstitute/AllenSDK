...
doc: FORCE
	...
	sed -i --expression "s/\/_static/${STATIC}\/_static/g" doc/_templates/layout.html
	sed -i --expression "s/\/_static/${STATIC}\/_static/g" doc/_templates/portalHeader.html
	sed -i --expression "s/\/_static/${STATIC}\/_static/g" doc/_static/external_assets/javascript/portal.js
