...
from allensdk.brain_observatory.behavior.behavior_session import (
    BehaviorSession)
from allensdk.brain_observatory.behavior.ophys_session import (
    OphysSession)
...
from allensdk.brain_observatory.behavior.data_objects import \
    OphysSessionId, StimulusTimestamps
    ...
    def from_lims(cls,
        ...
        if is_multiplane_session:
            ophys_timestamps = OphysTimestampsMultiplane.from_sync_file(
                sync_file=sync_file,
                group_count=meta.imaging_plane_group_count,
                plane_group=meta.imaging_plane_group
            )
        else:
