...
jobdir = '/allen/programs/braintv/workgroups/nc-ophys/nick.ponvert/cluster_jobs/20190810_save_flash_response_df'
...
for experiment_id in experiment_ids:
    PythonJob(
        ...
        conda_env = None,
        jobname = 'flash_response_df_{}'.format(experiment_id),
        **job_settings
    ).run(dryrun=False)
