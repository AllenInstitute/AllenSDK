...
# this lets the docs build in a headless environment
import matplotlib
...
# The name of an image file (within the te path) to use as favicon of the
...
html_static_path = ["aibs_sphinx/static", "examples_root"]
...
latex_documents = [
    ("index", "Allen SDK.tex", "Allen SDK Documentation", "Allen Institute for Brain Science", "manual"),
]
...
man_pages = [("index", "Allen SDK", "Allen SDK Documentation", ["Allen Institute for Brain Science"], 1)]
