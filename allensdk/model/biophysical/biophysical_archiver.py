...
class BiophysicalArchiver(object):
    ...
    def get_stimulus_file(self, neuronal_model_id):
        result = self.rma.model_query('NeuronalModel',
                                      ...
                                      include="specimen(ephys_result(well_known_files(well_known_file_type[name$eq'NWB'])))",
                                      tabular=['path'])
...
if __name__ == '__main__':
    ba = BiophysicalArchiver('/data/informatics/mousecelltypes/model_cache_may_2015')
