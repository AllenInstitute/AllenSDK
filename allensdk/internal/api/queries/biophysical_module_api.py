...
class BiophysicalModuleApi(RmaTemplate):
    ...
    def __init__(self, base_uri=None):
        super(BiophysicalModuleApi, self).__init__(base_uri, query_manifest=BiophysicalModuleApi.rma_templates)
    ...
    def get_neuronal_model_runs(self, neuronal_model_run_ids=None):
        ...
        data = self.template_query(
            "biophysical_lims_queries", "neuronal_model_runs_by_ids", neuronal_model_run_ids=neuronal_model_run_ids
        )
    ...
    def get_neuronal_models(self, neuronal_model_ids=None):
        ...
        """
        data = self.template_query(
            "biophysical_lims_queries", "neuronal_models_by_ids", neuronal_model_ids=neuronal_model_ids
        )
