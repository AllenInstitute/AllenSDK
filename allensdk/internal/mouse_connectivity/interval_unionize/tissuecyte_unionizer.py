...
from .tissuecyte_unionize_record import TissuecyteInjectionUnionize, TissuecyteProjectionUnionize
...
class TissuecyteUnionizer(IntervalUnionizer):
    ...
    @classmethod
    def record_cb(cls):
        return {"injection": TissuecyteInjectionUnionize(), "projection": TissuecyteProjectionUnionize()}
    ...
    def postprocess_unionizes(
        self, raw_unionizes, image_series_id, output_spacing_iso, volume_scale, target_shape, sort
    ):
        """As parent
