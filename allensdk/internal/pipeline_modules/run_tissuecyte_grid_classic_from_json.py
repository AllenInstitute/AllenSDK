...
from allensdk.internal.mouse_connectivity.tissuecyte_gridding.run_classic import run_classic
from allensdk.internal.mouse_connectivity.tissuecyte_gridding.classic_subimage import ClassicSubImage
...
def main():
    ...
    subimage_kwargs = {'cls': ClassicSubImage}
    if args.filter_bit is not None:
        subimage_kwargs['filter_bit'] = args.filter_bit

    paths = run_classic(grid_prefix=input_data['grid_prefix'], 
