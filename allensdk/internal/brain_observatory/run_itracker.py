...
def run_itracker(
    ...
    **kwargs,
    ...
    input_stream = FfmpegInputStream(
        movie_file,
        frame_shape,
    ...
    movie_output_stream = (
        FfmpegOutputStream(frame_shape, block_size=output_annotated_movie_block_size, ffmpeg_bin=FFMPEG_BIN)
        if output_annotated_movie
        else None
    )
    ...
    itracker.process_movie(
        movie_output_stream=movie_output_stream,
