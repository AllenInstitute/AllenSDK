...
class BiophysicalArchiver(object):
    ...
    def archive_cell(self, ephys_result_id, specimen_id, template, neuronal_model_id):
        ...
        file_name = os.path.join(
            self.archive_dir,
            "ephys_result_%d_specimen_%d_%s_neuronal_model_%d.zip"
            % (ephys_result_id, specimen_id, template, neuronal_model_id),
        )
        ...
        self.nwb_list.append("%s\t%s" % (os.path.basename(nwb_file), file_name))
