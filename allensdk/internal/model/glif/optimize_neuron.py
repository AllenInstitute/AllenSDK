...
def optimize_neuron(model_config, sweep_index, nwb_file, save_callback=None):
    ...
    optimize_data = load_sweeps(
        nwb_file, optimize_sweeps, neuron.dt, optimizer_config["cut"], optimizer_config["bessel"]
    )
