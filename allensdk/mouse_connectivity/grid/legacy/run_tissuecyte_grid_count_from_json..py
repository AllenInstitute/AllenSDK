...
from allensdk.internal.mouse_connectivity.tissuecyte_gridding.run count import run_count
from allensdk.internal.mouse_connectivity.tissuecyte_gridding.classic_count_subimage import ClassicCountSubImage
...
def main():
    ...
    subimage_kwargs = {'cls': ClassicCountSubImage}
    if args.filter_bit is not None:
        subimage_kwargs['filter_bit'] = args.filter_bit

    paths = run_count(grid_prefix=input_data['grid_prefix'], 
