...
def count_writer(gridder, grid_prefix, accumulator_prefix, target_spacings, **kwargs):
    ...
    ratio_and_pyramid(
        gridder,
        "injection_sum_projecting_pixels",
        "sum_pixels",
        "injection_density",
        accumulator_prefix,
        grid_prefix,
    ...
    ratio_and_pyramid(
        gridder,
        "aav_exclusion_sum_pixels",
        "sum_pixels",
        "aav_exclusion_fraction",
        accumulator_prefix,
        grid_prefix,
        target_spacings,
        paths=paths,
...
def classic_writer(gridder, grid_prefix, accumulator_prefix, target_spacings, **kwargs):
    ...
    ratio_and_pyramid(
        gridder,
        "sum_projecting_pixel_intensities",
        "sum_pixels",
        "projection_energy",
        accumulator_prefix,
        grid_prefix,
    ...
    ratio_and_pyramid(
        gridder,
        "injectionsum_projecting_pixel_intensities",
        "sum_pixels",
        "injection_energy",
        accumulator_prefix,
        grid_prefix,
...
def handle_pyramid(isg, key, target_spacings, prefix, paths):
    ...
    for tspacing in target_spacings:
        ...
        write_volume(
            image_from_array(downsampled, [tspacing] * 3), key, prefix=prefix, specify_resolution=tspacing, paths=paths
        )
