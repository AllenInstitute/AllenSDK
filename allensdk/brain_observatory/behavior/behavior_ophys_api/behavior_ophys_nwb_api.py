...
def _get_expt_description(session_type: str) -> str:
    ...
    ophys_2_5 = {
        "OPHYS_2": ("2-photon calcium imaging in the visual cortex of the "
                    ...
                    "loop mode)."),
        "OPHYS_5": ("2-photon calcium imaging in the visual cortex of the "
                    "mouse brain as the mouse is shown images from a "
                    "change detection task with a set of natural scenes "
    ...
    def save(self, session_object):
        ...
        nwbfile = NWBFile(
            ...
            keywords=["2-photon", "calcium imaging", "visual cortex",
                      "behavior", "task"],
            experiment_description=_get_expt_description(session_type)
        )
