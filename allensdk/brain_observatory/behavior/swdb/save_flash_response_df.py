...
from allensdk.brain_observatory.behavior.swdb.analysis_tools import get_trace_around_timepoint, get_mean_in_window
...
def get_flash_response_df(session, response_analysis_params):
    ...
    """
    frame_rate = 31.0  # Shouldn't hard code this here
    ...
    for cell_specimen_id, flash_id in itertools.product(dff_traces.index, flashes.index):
        ...
        trace, trace_timestamps = get_trace_around_timepoint(
            full_cell_trace, timepoint, session.ophys_timestamps, window_around_timepoint_seconds, frame_rate
        )
...
def get_p_values_from_shuffled_spontaneous(
    session, flash_response_df, response_window_duration=0.5, number_of_shuffles=10000
):
    """
...
if __name__ == "__main__":
    ...
    if case == 0:
        ...
        cache_json = {
            ...
            "analysis_files_base_dir": "/allen/programs/braintv/workgroups/nc-ophys/visual_behavior"
        ...
        output_path = (
            "/allen/programs/braintv/workgroups/nc-ophys/visual_behavior/SWDB_2019/flash_response_500msec_response"
        )

        # Define parameters for dff_trace, and response_window
        response_analysis_params = {
            "window_around_timepoint_seconds": [-0.5, 0.75],  # -500ms, 750ms
