...
mega_trial_mdf = ut.create_multi_session_mean_df(
    cache, experiment_ids, conditions=["cell_specimen_id", "change_image_name"]
)
...
mega_flash_mdf = ut.create_multi_session_mean_df(
    cache, experiment_ids, flashes=True, conditions=["cell_specimen_id", "image_name"]
)
save_dir = r"/allen/programs/braintv/workgroups/nc-ophys/visual_behavior/SWDB_2019"
