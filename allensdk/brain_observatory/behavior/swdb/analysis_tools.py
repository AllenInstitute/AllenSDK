...
if __name__ == "__main__":
    ...
    t_vals, t_ts = get_trace_around_timepoint(trace, 49.9, timestamps, window_around_timepoint_seconds, frame_rate=1)

    assert np.all(t_vals == np.array([45.0, 46.0, 47.0, 48.0, 49.0, 50.0, 51.0, 52.0, 53.0, 54.0]))
