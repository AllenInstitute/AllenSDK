...
from allensdk.brain_observatory.behavior.data_objects.metadata.ophys_experiment_metadata.ophys_container_id import (
    OphysContainerId,
)  # NOQA
...
from allensdk.brain_observatory.behavior.data_objects.metadata.ophys_experiment_metadata.ophys_project_code import (
    OphysProjectCode,
)  # NOQA
from allensdk.brain_observatory.behavior.data_objects.metadata.ophys_experiment_metadata.targeted_imaging_depth import (
...
class MultiplaneMetadata(OphysExperimentMetadata):
    ...
    @classmethod
    def from_lims(cls, ophys_experiment_id: int, lims_db: PostgresQueryMixin) -> "MultiplaneMetadata":
        ophys_experiment_metadata = OphysExperimentMetadata.from_lims(
            ophys_experiment_id=ophys_experiment_id, lims_db=lims_db
        )
        imaging_plane_group = ImagingPlaneGroup.from_lims(ophys_experiment_id=ophys_experiment_id, lims_db=lims_db)
        return cls(
