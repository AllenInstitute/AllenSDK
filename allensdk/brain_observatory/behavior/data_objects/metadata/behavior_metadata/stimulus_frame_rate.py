...
from allensdk.brain_observatory.behavior.data_objects.timestamps.stimulus_timestamps.stimulus_timestamps import (
    StimulusTimestamps,
)
from allensdk.brain_observatory.behavior.data_objects.timestamps.util import calc_frame_rate


class StimulusFrameRate(DataObject, StimulusFileReadableInterface, NwbReadableInterface):
    """Stimulus frame rate"""
    ...
    @classmethod
    def from_stimulus_file(cls, stimulus_file: BehaviorStimulusFile) -> "StimulusFrameRate":
