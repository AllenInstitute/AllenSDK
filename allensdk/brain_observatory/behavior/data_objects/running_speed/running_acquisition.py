...
class RunningAcquisition(DataObject, NwbReadableInterface, NwbWritableInterface):
    ...
    def from_multiple_stimulus_files(
        ...
        return cls(running_acquisition=df, stimulus_file=None, stimulus_timestamps=None)
    ...
    def from_nwb(cls, nwbfile: NWBFile) -> "RunningAcquisition":
        ...
        running_acq_df = pd.DataFrame(
            {"dx": dx, "v_in": v_in, "v_sig": v_sig}, index=pd.Index(timestamps, name="timestamps")
        )
