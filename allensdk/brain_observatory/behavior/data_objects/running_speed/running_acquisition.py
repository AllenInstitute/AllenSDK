...
class RunningAcquisitionNWBMixin(object):
    """
    Mixin for defining to_nwb and from_nwb for
    RunningAcquisition data objects
    """
    ...
    def from_nwb(
        ...
        return cls(data=running_acq_df)
...
class RunningAcquisition(RunningAcquisitionNWBMixin,
                         DataObject, LimsReadableInterface,
    ...
    def __init__(
        ...
        super().__init__(name="running_acquisition", value=data)
