...
def get_rolling_dprime(rolling_hit_rate, rolling_fa_rate, limits=(0.01, 0.99)):
    return np.array([get_dprime(hr, far, limits=limits) for hr, far in zip(rolling_hit_rate, rolling_fa_rate)])
