...
from allensdk.brain_observatory.behavior.behavior_project_cache.tables.project_table import ProjectTable
...
class ExperimentsTable(ProjectTable, OphysMixin):
    ...
    def __init__(self, df: pd.DataFrame, suppress: Optional[List[str]] = None, passed_only: bool = True):
        """
        Parameters
        ----------
        df: pd.DataFrame
