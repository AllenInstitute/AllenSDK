...
def make_frame(t):
    ...
    try:
        ellipse = Ellipse(
            (cr.loc[fi]["center_x"], cr.loc[fi]["center_y"]),
            2 * cr.loc[fi]["width"],
            2 * cr.loc[fi]["height"],
            np.rad2deg(cr.loc[fi]["phi"]),
            alpha=0.8,
            ec="r",
            fc=None,
            lw=2,
    ...
    try:
        ellipse = Ellipse(
            (eye.loc[fi]["center_x"], eye.loc[fi]["center_y"]),
            2 * eye.loc[fi]["width"],
            2 * eye.loc[fi]["height"],
            np.rad2deg(eye.loc[fi]["phi"]),
            alpha=0.8,
            ec="g",
            fc=None,
            lw=2,
    ...
    try:
        ellipse = Ellipse(
            (pupil.loc[fi]["center_x"], pupil.loc[fi]["center_y"]),
            2 * pupil.loc[fi]["width"],
            2 * pupil.loc[fi]["height"],
            np.rad2deg(pupil.loc[fi]["phi"]),
            alpha=0.8,
            ec="b",
            fc=None,
            lw=2,
