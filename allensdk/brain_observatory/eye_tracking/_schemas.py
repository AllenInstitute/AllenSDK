...
class InputSchema(ArgSchema):
    ...
    ellipse_output_data_file = String(
        required=True, validate=check_write_access_overwrite, description="write outputs to here"
    )
    ellipse_output_video_file = String(
        required=False, validate=check_write_access_overwrite, description="write outputs to here"
    )
    points_output_video_file = String(
        required=False, validate=check_write_access_overwrite, description="write outputs to here"
    )
