...
from allensdk.brain_observatory.nwb import add_running_speed_to_nwbfile, add_stimulus_presentations_to_file
...
def write_ecephys_nwb(
    ...
    **kwargs
    ...
    nwbfile = add_stimulus_presentations_to_file(nwbfile, stimulus_table)
