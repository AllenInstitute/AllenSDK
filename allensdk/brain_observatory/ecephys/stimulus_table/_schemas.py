...
class InputParameters(ArgSchema): 
    ...
    minimum_spontaneous_activity_duration = Float(default=0.0, help="detected spontaneous activity sweeps will be refected if they last fewer that this many seconds")
