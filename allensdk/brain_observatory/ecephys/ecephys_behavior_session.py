...
from allensdk.brain_observatory.ecephys.data_objects.ecephys_licks import EcephysLicks
...
from allensdk.brain_observatory.ecephys.data_objects.metadata \
    .ecephys_behavior_metadata.ecephys_behavior_metadata import \
    EcephysBehaviorMetadata
...
from allensdk.brain_observatory.ecephys.data_objects.timestamps \
...
from allensdk.brain_observatory.ecephys.write_ecephys_behavior_nwb.nwb_helper import \
    NwbHelper
...
class EcephysBehaviorSession(
    ...
    """
    def __init__(self,
        metadata: EcephysBehaviorMetadata,
        ...
        trials: TrialTable,
        running_speed: VBNRunningSpeed,
        raw_running_speed: VBNRunningSpeed,
    ...
    def from_json(
        ...
        running_speed = VBNRunningSpeed.from_json(dict_repr=session_data,
                                                  filtered=True)
        ...
        #this handles everything else - refactor this class
        nwb_helper = NwbHelper(session_data, probes)
    ...
    def to_nwb(self, add_metadata=True) -> NWBFile:
        ...
        nwbfile = NWBFile(
            session_description=self._get_session_type(),
            identifier=self._get_identifier(),
            session_id=self._get_identifier(),
            session_start_time=self._date_of_acquisition.value,
    ...
    def _get_identifier(self) -> str:
        return str(self._ecephys_session_id)
