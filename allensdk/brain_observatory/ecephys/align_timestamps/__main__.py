...
def align_timestamps(args):
    ...
    for probe in args['probes']:
        ...
        probe_barcode_times, probe_barcodes = extract_barcodes_from_states(channel_states, timestamps, probe['sampling_rate'])
        ...
        for idx, split_time in enumerate(probe_split_times):
            ...
            synchronizer = ProbeSynchronizer.compute(
                sync_times, sync_codes, 
                probe_barcode_times, probe_barcodes, min_time, max_time,
                probe['start_index'], probe['sampling_rate']
            )
