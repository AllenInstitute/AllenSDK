...
class OptotaggingTable(DataObject, JsonReadableInterface, NwbWritableInterface, NwbReadableInterface):
    ...
    def __init__(self, table: pd.DataFrame):
        ...
        table = table.rename(columns={"name": "stimulus_name"})
    ...
    def to_nwb(self, nwbfile: NWBFile) -> NWBFile:
        ...
        optotagging_table = setup_table_for_epochs(optotagging_table, opto_ts, "optical_stimulation")
