...
from argschema.fields import Nested, String, Float, Dict


known_conditions = {
    "0": {"duration": 1.0, "name": "fast_pulses", "condition": "2.5 ms pulses at 10 Hz"},
    "1": {"duration": 0.005, "name": "pulse", "condition": "a single square pulse"},
    "2": {"duration": 0.01, "name": "pulse", "condition": "a single square pulse"},
    "3": {"duration": 1.0, "name": "raised_cosine", "condition": "half-period of a cosine wave"},
}
