...
def main():
    ...
    ellipse_series_spec = NWBGroupSpec(
        ...
        datasets=[
            ...
            NWBDatasetSpec(
                name="area", dtype="float", doc="ellipse area, with nan values in likely blink times", shape=(None,)
            ),
            NWBDatasetSpec(
                name="area_raw", dtype="float", doc="ellipse area, with no regard to likely blink times", shape=(None,)
            ),
            NWBDatasetSpec(name="width", dtype="float", doc="width of ellipse", shape=(None,)),
            NWBDatasetSpec(name="height", dtype="float", doc="height of ellipse", shape=(None,)),
            NWBDatasetSpec(name="angle", dtype="float", doc="angle that ellipse is rotated by (phi)", shape=(None,)),
        ],
    )
    ...
    ellipse_eye_tracking_spec = NWBGroupSpec(
        ...
        groups=[
            NWBGroupSpec(neurodata_type_inc=ellipse_series_spec, name=x, doc=x.replace("_", " "))
