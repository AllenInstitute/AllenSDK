...
class MesoscopeSession(LazyPropertyMixin):
    ...
    def __init__(self, session_id, api=None):

        self.session_id = session_id
        self.api = MesoscopeLimsApi() if api is None else api
        
        self.metadata = LazyProperty(self.api.get_metadata, ophys_experiment_id=self.ophys_experiment_id)
