...
class DualStimulusRunningSpeedInputParameters(argschema.ArgSchema):
...
class DualStimulusRunningSpeedOutputSchema(argschema.schemas.DefaultSchema):
...
class DualStimulusRunningSpeedOutputParameters(
    DualStimulusRunningSpeedOutputSchema
):
    output_path = argschema.fields.OutputFile(
        required=True,
