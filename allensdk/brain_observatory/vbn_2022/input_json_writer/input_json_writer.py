...
from allensdk.brain_observatory.vbn_2022.input_json_writer.schemas import VBN2022InputJsonWriterSchema
...
class VBN2022InputJsonWriter(argschema.ArgSchemaParser):
    ...
    def run(self):
        results = vbn_nwb_config_from_ecephys_session_id_list(
            ecephys_session_id_list=self.args["ecephys_session_id_list"], probes_to_skip=self.args["probes_to_skip"]
        )
