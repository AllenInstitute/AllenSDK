...
def classic_params():
    return {
        ...
        "polygon_info": {
            "missing_tile": [[(8000, 8000), (16000, 8000), (16000, 16000), (8000, 16000)]],
            "no_signal": [(4000, 4000), (8000, 4000), (8000, 8000), (4000, 8000)],
        },
    }
...
def test_process_segmentation(classic_params, segmentation_image, missing_tile, no_signal, projection, injection):
    si = ClassicSubImage(**classic_params)
