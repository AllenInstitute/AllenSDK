    ...
    subimages = [
        {
            ...
            "polygon_info": {"missing_tile": [], "no_signal": [], "aav_exclusion": []},
        }
    ]
...
@pytest.mark.parametrize(
    "gridder_fn,cgd,cgs,cgr",
    [
        (small_gridder, [951, 1267, 140], [11.05, 11.05, 100], 6),
...
def test_resample_volume():
    ...
    with mock.patch("SimpleITK.ReadImage", new=make_dfield):
        with mock.patch(
            "allensdk.mouse_connectivity.grid.utilities.image_utilities.build_composite_transform", new=make_transform
        ):
            gridder = small_gridder()
