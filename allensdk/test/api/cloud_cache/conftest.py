...
def example_datasets_with_metadata(baseline_data_with_metadata):
    ...
    example['data']['1.0'] = data['data']
    example['metadata']['1.0'] = data['metadata']

    # delete one data file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['data'].pop('f2.txt')
    example['data']['2.0'] = data['data']
    example['metadata']['2.0'] = data['metadata']

    # rename one data file
    data = copy.deepcopy(baseline_data_with_metadata)
    old = data['data'].pop('f2.txt')
    data['data']['f4.txt'] = {'file_id': '4', 'data': old['data']}
    example['data']['3.0'] = data['data']
    example['metadata']['3.0'] = data['metadata']

    # change one data file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['data']['f3.txt'] = {'file_id': '3', 'data': b'44556677'}
    example['data']['4.0'] = data['data']
    example['metadata']['4.0'] = data['metadata']

    # add a data file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['data']['f4.txt'] = {'file_id': '4', 'data': b'44556677'}
    example['data']['5.0'] = data['data']
    example['metadata']['5.0'] = data['metadata']

    # delete a data file and change another
    data = copy.deepcopy(baseline_data_with_metadata)
    data['data'].pop('f2.txt')
    data['data']['f1.txt'] = {'file_id': '1', 'data': b'xxxxxx'}
    example['data']['6.0'] = data['data']
    example['metadata']['6.0'] = data['metadata']
    ...
    example['data']['7.0'] = data['data']
    example['metadata']['7.0'] = data['metadata']

    # delete a data file and add another
    data = copy.deepcopy(baseline_data_with_metadata)
    data['data'].pop('f2.txt')
    data['data']['f5.txt'] = {'file_id': '5', 'data': b'yyyyy'}
    example['data']['8.0'] = data['data']
    example['metadata']['8.0'] = data['metadata']
    ...
    example['data']['9.0'] = data['data']
    example['metadata']['9.0'] = data['metadata']

    # delete a metadata file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['metadata'].pop('metadata_2.csv')
    example['data']['10.0'] = data['data']
    example['metadata']['10.0'] = data['metadata']

    # rename a metadata file
    data = copy.deepcopy(baseline_data_with_metadata)
    old = data['metadata'].pop('metadata_2.csv')
    data['metadata']['metadata_4.csv'] = old
    example['data']['11.0'] = data['data']
    example['metadata']['11.0'] = data['metadata']

    # change a metadata file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['metadata']['metadata_3.csv'] = b'12345'
    example['data']['12.0'] = data['data']
    example['metadata']['12.0'] = data['metadata']

    # add a metadata file
    data = copy.deepcopy(baseline_data_with_metadata)
    data['metadata']['metadata_4.csv'] = b'12345'
    example['data']['13.0'] = data['data']
    example['metadata']['13.0'] = data['metadata']
    ...
    data['metadata']['metadata_4.csv'] = old
    example['data']['14.0'] = data['data']
    example['metadata']['14.0'] = data['metadata']
    ...
    example['data']['15.0'] = data['data']
    example['metadata']['15.0'] = data['metadata']
