...
def test_cache_file_attributes():
    attr = CacheFileAttributes(
        url="http://my/url", version_id="aaabbb", file_hash="12345", local_path=pathlib.Path("/my/local/path")
    )
    ...
    with pytest.raises(ValueError) as context:
        attr = CacheFileAttributes(
            url=5.0, version_id="aaabbb", file_hash="12345", local_path=pathlib.Path("/my/local/path")
        )
    ...
    with pytest.raises(ValueError) as context:
        attr = CacheFileAttributes(
            url="http://my/url/", version_id=5.0, file_hash="12345", local_path=pathlib.Path("/my/local/path")
        )
    ...
    with pytest.raises(ValueError) as context:
        attr = CacheFileAttributes(
            url="http://my/url/", version_id="aaabbb", file_hash=5.0, local_path=pathlib.Path("/my/local/path")
        )
    ...
    with pytest.raises(ValueError) as context:
        attr = CacheFileAttributes(
            url="http://my/url/", version_id="aaabbb", file_hash="12345", local_path="/my/local/path"
        )
