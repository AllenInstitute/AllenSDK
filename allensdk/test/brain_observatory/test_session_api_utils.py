...
def mixin_harness_fixture(request) -> ParamsMixinTestHarness:
    ...
    mixed_in = ParamsMixinTestHarness(
        param_to_ignore, a_param_1, a_param_2, b_param_1, c_param_1, d_param_1, e_param_1, f_param_1
    )
...
@pytest.mark.parametrize(
    "mixin_harness_fixture, expected",
    [
        (
            {},
            [
...
@pytest.mark.parametrize(
    ...
    [
        (
            {},
            {
                "param_to_ignore": Parameter.empty,
                "a_param_1": int,
                "a_param_2": float,
                "b_param_1": list,
                "c_param_1": bool,
    ...
    [
        (
            {},
            {
                ...
                "b_param_1": [1, 2, 3],
                "c_param_1": True,
                "d_param_1": np.array([5, 5]),
                "e_param_1": pd.Series([4.0, 5.0]),
                "f_param_1": pd.DataFrame([1, 2, 3]),
            },
        ),
        (
...
@pytest.mark.parametrize(
    "mixin_harness_fixture, params_to_set, expected",
    [
        (
            {},
            {"a_param_1": 5},
        ...
        (
            ...
            {"d_param_1": np.array([20, 20]), "e_param_1": pd.Series([1, 2, 3]), "b_param_1": [9, 10]},
            {
                ...
                "b_param_1": [9, 10],
                "c_param_1": True,
                "d_param_1": np.array([20, 20]),
                "e_param_1": pd.Series([1, 2, 3]),
                "f_param_1": pd.DataFrame([1, 2, 3]),
            },
        ),
    ],
...
def test_set_params_with_invalid_params(mixin_harness_fixture, params_to_set, expected):
...
@pytest.mark.parametrize(
    "mixin_harness_fixture, params_to_set, data_params, expected",
    [
        ({}, {"a_param_1": 42}, {"a_param_1"}, True),
        ({}, {"a_param_1": 8}, {"a_param_1"}, False),
        ({}, {"a_param_1": 8.0}, {"a_param_1"}, False),
        ({}, {"a_param_2": 3.0}, {"a_param_1"}, False),
        ({}, {"a_param_2": 2.5, "b_param_1": ["a", "b", "c"]}, {"b_param_1"}, True),
        ({}, {"a_param_1": 10, "a_param_2": 9.0}, {"b_param_1"}, False),
        ({}, {"d_param_1": np.array([98, 99, 100]), "a_param_2": 9.0}, {"d_param_1"}, True),
        ({}, {"d_param_1": np.array([98, 99, 100]), "e_param_1": pd.Series([1, 3, 5])}, {"e_param_1"}, True),
        ({}, {"d_param_1": np.array([98, 99, 100]), "e_param_1": pd.Series([4.0, 5.0])}, {"e_param_1"}, False),
    ],
    indirect=["mixin_harness_fixture"],
)
...
@pytest.mark.parametrize(
    "mixin_harness_fixture, data_params, expected",
    [
        ({"updated_params": {"a_param_1", "b_param_1"}}, {"a_param_1"}, {"b_param_1"}),
        ({"updated_params": {"a_param_1", "a_param_2", "b_param_1"}}, {"a_param_1", "a_param_2"}, {"b_param_1"}),
    ],
    indirect=["mixin_harness_fixture"],
)
