...
def use_temp_dir(tmpdir_factory):
    def fn(data_dir, tempdir_name, input_json_fname, output_json_fname, module, renamer_cb):
        ...
        sp.check_call(["python", "-m", module, "--input_json", new_input_json_path, "--output_json", output_json_path])
...
@pytest.mark.parametrize(
    "input_json_fname,output_json_fname,exp_fname",
    [
        [
...
def test_extract_running_speed_module(use_temp_dir, input_json_fname, output_json_fname, exp_fname):
