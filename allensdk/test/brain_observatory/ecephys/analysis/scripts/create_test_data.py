"""
This is a small script I've been using to create reasonable test units from Saskia's NWB1 version analysis code. I'm
leaving this in while the ecephys module is in development but in the future this should be removed.
