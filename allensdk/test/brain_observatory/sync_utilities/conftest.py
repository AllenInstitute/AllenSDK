...
@pytest.fixture
def line_to_edges_fixture(line_name_fixture, sync_sample_fixture):
    """
...
@pytest.fixture
def sync_metadata_fixture(sync_freq_fixture, line_name_fixture):
    """
...
def sync_file_fixture(
    sync_metadata_fixture, line_name_fixture, line_to_edges_fixture, sync_sample_fixture, tmp_path_factory
):
    """
    ...
    with h5py.File(sync_path, "w") as out_file:
        ...
        out_file.create_dataset("meta", data=json.dumps(sync_metadata_fixture).encode("utf-8"))
