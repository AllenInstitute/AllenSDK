...
def test_incomplete_eye_tracking(behavior_ophys_experiment_fixture, skeletal_nwb_fixture):
    ...
    assert populated_eye_tracking.index.name == empty_eye_tracking_df.index.name
...
@pytest.mark.requires_bamboo
def test_incomplete_eye_tracking_from_lims(behavior_ophys_experiment_fixture):
    """
    ...
    incomplete_experiment = BehaviorOphysExperiment.from_lims(incomplete_exp_id)
...
@pytest.mark.requires_bamboo
def test_incomplete_licks(behavior_ophys_experiment_fixture, skeletal_nwb_fixture):
...
@pytest.mark.requires_bamboo
def test_incomplete_rewards(behavior_ophys_experiment_fixture, skeletal_nwb_fixture):
...
@pytest.mark.requires_bamboo
def test_incomplete_rig_geometry(behavior_ophys_experiment_fixture, skeletal_nwb_fixture):
    populated_rig_geom = behavior_ophys_experiment_fixture.eye_tracking_rig_geometry
    ...
    assert behavior_ophys_experiment_fixture._eye_tracking_rig_geometry is not None
