...
@pytest.mark.parametrize(
    ...
    (
        [{"images1": None, "Other Input": None}, "Found multiple image StimulusTemplates"],
        [{"movie1": None, "movie2": None}, "Found multiple fingerprint movie StimulusTemplate"],
        [
            {"images1": None, "Other Input": None, "movie1": None, "movie2": None},
