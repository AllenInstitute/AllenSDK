...
class TestNWB:
    ...
    def test_read_write_nwb(self, roundtrip, data_object_roundtrip_fixture, is_stimulus_duration_sec_nan):
        ...
        if roundtrip:
            obt = data_object_roundtrip_fixture(nwbfile=self.nwbfile, data_object_cls=TaskParameters)
        else:
