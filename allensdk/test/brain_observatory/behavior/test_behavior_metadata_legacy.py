            ...
            {  # noqa: E128
                "items": {
                    "behavior": {
                        ...
                        "params": {"stage": "TRAINING_3_images_A", "flash_omit_probability": 0.05},
                        "stimuli": {"images": {"draw_log": [1] * 10, "flash_interval_sec": [0.32, -1.0]}},
                    }
                }
            },
            {
        ...
        pytest.param(
            {
                "items": {
                    "behavior": {
                        ...
                        "params": {"stage": "TRAINING_3_images_A", "flash_omit_probability": 0.05},
                        "stimuli": {"grating": {"draw_log": [1] * 10, "flash_interval_sec": [0.34, -1.0]}},
                    }
                }
            },
            {
        ...
        pytest.param(
            {
                "items": {
                    "behavior": {
                        ...
                        "params": {"stage": "TRAINING_3_images_A", "flash_omit_probability": 0.05},
                        "stimuli": {"grating": {"draw_log": [1] * 10, "flash_interval_sec": None}},
                    }
                }
            },
            {
    ...
    input_data = {
        "items": {
            "behavior": {
                ...
                "params": {"stage": "TRAINING_3_images_A", "flash_omit_probability": 0.05},
                "stimuli": {"junk": {"draw_log": [1] * 10, "flash_interval_sec": [0.32, -1.0]}},
            }
        }
    }
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("TRAINING_3_images_A_10uL_reward", description_dict[r"\ATRAINING_3_images"]),
        ("TRAINING_5_images_A_handoff_lapsed", description_dict[r"\ATRAINING_5_images"]),
    ],
)
def test_get_expt_description_with_valid_session_type(session_type, expected_description):
    obt = get_expt_description(session_type)
    assert obt == expected_description


@pytest.mark.parametrize("session_type", [("bogus_session_type"), ("stuff"), ("OPHYS_7")])
