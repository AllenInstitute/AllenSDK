...
def api_data():
    return {
        702134928: {
            "ophys_dir": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/",  # noqa: E501
            "demix_file": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/demix/702134928_demixed_traces.h5",  # noqa: E501
            "maxint_file": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/processed/ophys_cell_segmentation_run_814561221/maxInt_a13a.png",  # noqa: E501
            "avgint_a1X_file": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/processed/ophys_cell_segmentation_run_814561221/avgInt_a1X.png",  # noqa: E501
            "rigid_motion_transform_file": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/processed/702134928_rigid_motion_transform.csv",  # noqa: E501
            "input_extract_traces_file": "/allen/programs/braintv/production/neuralcoding/prod0/specimen_652073919/ophys_session_702013508/ophys_experiment_702134928/processed/702134928_input_extract_traces.json",  # noqa: E501
...
@pytest.mark.parametrize(
    "ophys_experiment_id, compare_val",
    [
        pytest.param(
            511458874,
            "/allen/programs/braintv/production/neuralcoding/prod6/specimen_503292442/ophys_experiment_511458874/511458874.nwb",  # noqa: E501
        ),
        pytest.param(0, None),
    ],
)
...
@pytest.mark.requires_bamboo
@pytest.mark.parametrize(
    "ophys_lims_experiment_id, compare_val",
    [pytest.param(511458874, 0.785203), pytest.param(0, None)],
)
...
@pytest.mark.parametrize(
    "ophys_lims_experiment_id, compare_val",
    [pytest.param(842510825, "M"), pytest.param(0, None)],
)
...
@pytest.mark.parametrize(
    "ophys_lims_experiment_id, compare_val",
    [pytest.param(842510825, "P157"), pytest.param(0, None)],
)
