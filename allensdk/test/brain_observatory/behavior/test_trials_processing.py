...
def trial_data_and_expectation_0():
    test_trial = {
        ...
        "stimulus_changes": [
            (("im065", "im065"), ("im062", "im062"), 317.76644976765834, 18706)
        ],
        "success": False,
...
def trial_data_and_expectation_2():
    test_trial = {
        ...
        "stimulus_changes": [
            (("im069", "im069"), ("im085", "im085"), 542.2007438794369, 32161)
        ],
        "success": True,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            True,
            False,
            "both `hit` and `false_alarm` cannot be True",
        ),  # hit and false alarm
        (
            True,
            True,
            ...
            False,
            False,
            "both `go` and `catch` cannot be True",
        ),  # go and catch
        (
            True,
            False,
...
def test_get_trial_timing():
    ...
    # use assert_frame_equal to take advantage of the nice way it deals
    # with NaNs
...
def test_resolve_initial_image(
    behavior_stimuli_data_fixture, start_frame, expected
):
    ...
    [
        ...
        (
            {},
            {
                ...
                "stimulus_changes": [
                    (("horizontal", 90), ("vertical", 180), None, None)
                ],
            },
            {
                "initial_image_name": "gratings_90",
        ...
        (
            ...
            },
            {
                ...
                "stimulus_changes": [
                    (("im065", "im065"), ("im057", "im057"), None, None)
                ],
            },
