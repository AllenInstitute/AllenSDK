...
@pytest.mark.parametrize(
    "sync_path, sync_key, count_exp, last_exp",
    [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [sync.get_trigger, "2p_acq_trigger", [1, 2, 3], [4, 5, 6], [1, 2, 3]],
        [sync.get_trigger, "2p_acquiring", [1, 2, 3], [4, 5, 6], [1, 2, 3]],
        ...
        [sync.get_behavior_monitoring, "beh_frame_received", [1, 2, 3], [4, 5, 6], [1, 2, 3]],
