...
def test_locate_h5_objects(simple_h5):
    matcher_cb = functools.partial(h5_utilities.h5_object_matcher_relname_in,
                                   ['c', 'e'])
...
def test_keyed_locate_h5_objects(simple_h5):
    matcher_cbs = {
        'e': functools.partial(h5_utilities.h5_object_matcher_relname_in,
                               ['e']),
        'c': functools.partial(h5_utilities.h5_object_matcher_relname_in,
                               ['c']),
    }
...
def test_load_datasets_by_relnames(simple_h5_with_datsets):
    ...
    obt = h5_utilities.load_datasets_by_relnames(relnames,
                                                 simple_h5_with_datsets,
                                                 simple_h5_with_datsets['a/b'])
