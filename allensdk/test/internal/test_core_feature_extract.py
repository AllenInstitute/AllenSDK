...
def test_filter_sweeps():
    ...
    a = [
        {"sweep_number": 1, "workflow_state": "auto_passed", "stimulus_units": "fish"},
    ...
    a = [
        {"sweep_number": 1, "ephys_stimulus": {"description": "T1x"}},
    ...
    a = [
        {
            ...
            "sweep_number": 1,
            "ephys_stimulus": {"description": "C1LSCOARSE"},
        ...
        },
        {
            "stimulus_amplitude": 10,
            "sweep_number": 0,
            "ephys_stimulus": {"description": "C1LSFINE"},
            "workflow_state": "auto_passed",
            "stimulus_units": "pA",
        },
        {
