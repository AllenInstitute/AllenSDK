...
def test_download_injection_density(connectivity, storage_dirs, fn_temp_dir):
    ...
    target = os.path.join(fn_temp_dir, "experiment_{0}".format(eid), "injection_density_25.nrrd")

    with mock.patch("allensdk.internal.api.api_prerelease.ApiPrerelease.retrieve_file_from_storage") as gda:
...
def test_download_projection_density(connectivity, storage_dirs, fn_temp_dir):
    ...
    target = os.path.join(fn_temp_dir, "experiment_{0}".format(eid), "projection_density_25.nrrd")
...
def test_download_injection_fraction(connectivity, storage_dirs, fn_temp_dir):
    ...
    target = os.path.join(fn_temp_dir, "experiment_{0}".format(eid), "injection_fraction_25.nrrd")
...
def test_download_data_mask(connectivity, storage_dirs, fn_temp_dir):
    ...
    target = os.path.join(fn_temp_dir, "experiment_{0}".format(eid), "data_mask_25.nrrd")
