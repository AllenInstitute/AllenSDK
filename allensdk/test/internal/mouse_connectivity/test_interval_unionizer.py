...
from allensdk.internal.mouse_connectivity.interval_unionize.interval_unionizer import IntervalUnionizer
...
def test_propagate_unionizes():
    uns = {1: {"a": 1, "b": 2}, 2: {"a": 2, "b": 3}, 3: {"a": 3, "b": 4}}
...
def test_direct_unionize():
    ...
    with mock.patch(
        "allensdk.internal.mouse_connectivity.interval_unionize.interval_unionizer.IntervalUnionizer.sort_data_arrays",
        new=lambda s, x: x,
    ):
