...
@pytest.mark.parametrize(
    "ismount,base_path",
    [(True, os.path.normpath(os.path.join("/", "dev", "shm"))), (False, os.path.dirname(temp_dir.__file__))],
)
@patch("numpy.random.randint", side_effect=([1, 2, 3, 4, 5, 6], [1, 2, 3, 4, 5, 7]))
@patch("os.listdir", return_value=["allensdk_test_123456"])
@patch("os.makedirs")
def test_tmp_dir(os_makedirs, os_listdir, randint, mock_request, ismount, base_path):
